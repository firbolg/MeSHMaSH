...
<br>-Counts and sorts the MeSH terms previously used to index the SDOH term
<br>-Collates each SDOH term with the top associated MeSH terms
<br>-Saves everything as a .csv file
